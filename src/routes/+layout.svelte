<script lang="ts">
	...
	/**
	 * Приветствие показывается только после гидратации.
	 *
	 * До неё настройки — значения по умолчанию, и онбординг мигнул бы даже
	 * тому, кто его давно прошёл. Флаг закрытия локальный: сам факт
	 * прохождения хранится в настройках и уезжает в синхронизацию.
	 */
