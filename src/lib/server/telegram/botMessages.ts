 ...
 * три способа записать и один шаг дальше. Приветствие, из которого непонятно,
 * что нажимать, — это потерянный человек на первом же экране.
 */
export const WELCOME_TEXT = [
	'Flux Planner — питание, привычки и деньги одного дня на одном экране.',
	'',
	'Записать можно тремя способами:',
	'• фото блюда — разберу на продукты и посчитаю калории',
	'• фраза в чат: «450 борщ», «ужин в 19:00», «1,5к на такси»',
	'• голосом с телефона, не открывая чат — включается в настройках',
	'',
	'Откройте приложение: пять вопросов, и цели посчитаются под вас.'
].join('\n');
