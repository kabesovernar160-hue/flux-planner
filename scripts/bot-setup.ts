...
const DESCRIPTION = [
	'Дневник, который доживает до второй недели.',
	'',
	'📷 Фото тарелки — разберу на продукты и посчитаю калории',
	'💬 «закинул 1,5к на такси» — запишу в траты',
	'🎙 Скажите телефону — запись появится сама, даже не открывая чат',
	'',
	'Питание, привычки и деньги одного дня на одном экране.',
	'Нажмите «Начать».'
].join('\n');

/** Показывается в профиле бота и в поиске. До 120 символов. */
const SHORT_DESCRIPTION =
	'Дневник питания, привычек и денег. Фото тарелки — калории, фраза — запись.';
